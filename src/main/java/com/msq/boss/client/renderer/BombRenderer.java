...
public class BombRenderer extends EntityRenderer<BombEntity> {
	private static final ResourceLocation texture = new ResourceLocation("msqboss:textures/entities/bomb.png");
	...
	@Override
	public void render(BombEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
